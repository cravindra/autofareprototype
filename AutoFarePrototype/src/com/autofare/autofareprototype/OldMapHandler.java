...
public class OldMapHandler {
	...
	public OldMapHandler( final GoogleMap map,TextView tvEstFare, EditText etSrcAdd,
	...
	void addPoints(LatLng p)
	{
		
	}
	
	void setMarkers(LatLng src, LatLng dest)
	{
	...
	{
		String origin=etSrcAdd.getText().toString().toLowerCase().replace(' ', '+');
		String dest=etDestAdd.getText().toString().toLowerCase().replace(' ', '+');
	...
	// Fetches data from url passed
	    ...
	    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>>
	    {
	        ...
	        protected void onPostExecute(List<List<HashMap<String, String>>> result)
	        {
	           ...
	           //Zooming to view
	           map.moveCamera(CameraUpdateFactory.newLatLngBounds(new LatLngBounds(start, stop), 100));
	        }
	    }
